...
IPCM_INC    := $(MW_PATH)/modules/ipcm/include
MSG_INC     := $(MW_PATH)/modules/msg/include
...
MW_INTERNAL_INC := $(MW_PATH)/internal_include
#
...
ALIOS_MMF_DIR := $(MW_PATH)/../cvi_alios/components/cvi_mmf_sdk
IPCM_DIR :=  $(OSDRV_PATH)/interdrv/ipcm
ISP_INC := $(MW_PATH)/include/isp/$(CHIP_ARCH_L)

export OSDRV_PATH KERNEL_PATH ALIOS_MMF_DIR IPCM_DIR CHIP_ARCH

...
static struct video_timing video_1440x720_60Hz    ={212,120, 240,1440, 2012, 20,  4,  20, 720, 764, 1,1,4,AR_16_9,92500};
...
void LT9611_Video_Check(void) //dsren
{
    ...
    printf( "\33[32m\n");
    printf( "-----------------------------------------------------------------------------\n");
    printf( "LT9611_Video_Check: h_total_sysclk = %d",h_total_sysclk);
...
//DTV
	...
	else if((h_act==(video_1440x720_60Hz.hact))&&(v_act==video_1440x720_60Hz.vact))
	{
		printf( " video_1440x720_60Hz \n");
		Video_Format = video_1440x720_60Hz_vic;
		video = &video_1440x720_60Hz;
	}
	else
	{
...
static void __upadte_video(LT9611_VIDEO_FORMAT_E enVideoFormat)
{
    ...
    case E_LT9611_VIDEO_1920x1080_60HZ:
        ...
        video = &video_1920x1080_60Hz;
        break;
	case E_LT9611_VIDEO_1440x720_60HZ:
        Video_Format = video_1440x720_60Hz_vic;
        video = &video_1440x720_60Hz;
		break;
    default:
...
CVI_S32 lt9611_get_video_format(char* pinput_str)
{
	...
	g_video_format = (LT9611_VIDEO_FORMAT_E)find_i;
	return CVI_SUCCESS;
}

...
CVI_S32 SAMPLE_VIO_TWO_DEV_VO(void)
{
	...
	stIniCfg = (SAMPLE_INI_CFG_S) {
		...
		.devNum    = 2,
		.enSnsType[0] = GCORE_GC2093_MIPI_2M_30FPS_10BIT,
		.enWDRMode[0] = WDR_MODE_NONE,
		.s32BusId[0]  = 3,
		.MipiDev[0]   = 0xff,
		.enSnsType[1] = GCORE_GC2053_1L_MIPI_2M_30FPS_10BIT,
		.s32BusId[1] = 0,
		.MipiDev[1] = 0xff,
	};
...
{
	SNS_TYPE_E  enSnsType	    = GCORE_GC4653_MIPI_4M_30FPS_10BIT;
...
{
	SNS_TYPE_E  enSnsType	    = SENSOR0_TYPE;
	WDR_MODE_E	   enWDRMode	    = WDR_MODE_NONE;
	DYNAMIC_RANGE_E    enDynamicRange   = DYNAMIC_RANGE_SDR8;
	PIXEL_FORMAT_E     enPixFormat	    = SAMPLE_PIXEL_FORMAT;
	VIDEO_FORMAT_E     enVideoFormat    = VIDEO_FORMAT_LINEAR;

...
CVI_S32 SAMPLE_COMM_VENC_SaveChannelStream(vencChnCtx *pvecc)
{
	...
	do {
		s32Ret = API_COST_TIME_LOG(CVI_VENC_GetChnAttr(VencChn, &stVencChnAttr), "CVI_VENC_GetChnAttr");
		...
		s32Ret = API_COST_TIME_LOG(CVI_VENC_QueryStatus(VencChn, &stStat), "CVI_VENC_QueryStatus");
		if (s32Ret != CVI_SUCCESS) {
...
RETRY_GET_STREAM:
		...
		s32Ret = API_COST_TIME_LOG(CVI_VENC_ReleaseStream(VencChn, &stStream), "CVI_VENC_ReleaseStream");
		if (s32Ret != CVI_SUCCESS) {
...
static CVI_S32 SAMPLE_COMM_VENC_DetachVbPool(VENC_CHN VencChn)
{
	...
	s32Ret = API_COST_TIME_LOG(CVI_VENC_GetChnAttr(VencChn, &stChnAttr), "CVI_VENC_GetChnAttr");
	if (s32Ret != CVI_SUCCESS) {
	...
	s32Ret = API_COST_TIME_LOG(CVI_VENC_GetModParam(&stModParam), "CVI_VENC_GetModParam");
	if (s32Ret != CVI_SUCCESS) {
	...
	if (eVbSource == VB_SOURCE_USER) {
		s32Ret = API_COST_TIME_LOG(CVI_VENC_DetachVbPool(VencChn), "CVI_VENC_DetachVbPool");
		if (s32Ret != CVI_SUCCESS) {
...
CVI_S32 SAMPLE_COMM_VENC_Stop(VENC_CHN VencChn)
{
	...
	s32Ret = API_COST_TIME_LOG(CVI_VENC_StopRecvFrame(VencChn), "CVI_VENC_StopRecvFrame");
	if (s32Ret != CVI_SUCCESS) {
	...
	s32Ret = API_COST_TIME_LOG(CVI_VENC_ResetChn(VencChn), "CVI_VENC_ResetChn");
	if (s32Ret != CVI_SUCCESS) {
	...
	s32Ret = API_COST_TIME_LOG(CVI_VENC_DestroyChn(VencChn), "CVI_VENC_DestroyChn");
	if (s32Ret != CVI_SUCCESS) {
...
CVI_S32 SAMPLE_COMM_VENC_CloseReEncode(VENC_CHN VencChn)
{
	...
	s32Ret = API_COST_TIME_LOG(CVI_VENC_GetRcParam(VencChn, &stRcParam), "CVI_VENC_GetRcParam");
	if (s32Ret != CVI_SUCCESS) {
	...
	s32Ret = API_COST_TIME_LOG(CVI_VENC_SetRcParam(VencChn, &stRcParam), "CVI_VENC_SetRcParam");
	if (s32Ret != CVI_SUCCESS) {
...
CVI_S32 SAMPLE_COMM_VENC_SetRoiAttr(VENC_CHN VencChn, PAYLOAD_TYPE_E enType)
{
	...
	for (i = 0; i < 4; i++) {
		s32Ret = API_COST_TIME_LOG(CVI_VENC_GetRoiAttr(VencChn, i, &RoiAttr), "CVI_VENC_GetRoiAttr");
		if (s32Ret != CVI_SUCCESS) {
		...
		s32Ret = API_COST_TIME_LOG(CVI_VENC_SetRoiAttr(VencChn, &RoiAttr), "CVI_VENC_SetRoiAttr");
		if (s32Ret != CVI_SUCCESS) {
		...
		VENC_GOP_ATTR_S *pstGopAttr)
{
	...
	if (pIc->bCreateChn == CVI_FALSE) {
		s32Ret = API_COST_TIME_LOG(CVI_VENC_CreateChn(VencChn, pstVencChnAttr), "CVI_VENC_CreateChn");
		if (s32Ret != CVI_SUCCESS) {
	...
	if (enType != PT_JPEG && enType != PT_MJPEG) {
		...
		if (eVbSource == VB_SOURCE_USER) {
			...
			s32Ret = API_COST_TIME_LOG(CVI_VENC_AttachVbPool(VencChn, &stPool), "CVI_VENC_AttachVbPool");
			if (s32Ret != CVI_SUCCESS) {
	...
	if (enType == PT_H264) {
		...
		s32Ret = API_COST_TIME_LOG(CVI_VENC_SetH264Entropy(VencChn, &h264Entropy), "CVI_VENC_SetH264Entropy");
		if (s32Ret != CVI_SUCCESS) {
		...
		VENC_CHN VencChn)
{
	...
	s32Ret = API_COST_TIME_LOG(CVI_VENC_GetRefParam(VencChn, pstRefParam), "CVI_VENC_GetRefParam");
	if (s32Ret != CVI_SUCCESS) {
	...
	s32Ret = API_COST_TIME_LOG(CVI_VENC_SetRefParam(VencChn, pstRefParam), "CVI_VENC_SetRefParam");
	if (s32Ret != CVI_SUCCESS) {
		...
		VENC_CHN VencChn)
{
	...
	s32Ret = API_COST_TIME_LOG(CVI_VENC_GetCuPrediction(VencChn, pstCuPrediction), "CVI_VENC_GetCuPrediction");
	if (s32Ret != CVI_SUCCESS) {
	...
	s32Ret = API_COST_TIME_LOG(CVI_VENC_SetCuPrediction(VencChn, pstCuPrediction), "CVI_VENC_SetCuPrediction");
	if (s32Ret != CVI_SUCCESS) {
		...
		VENC_CHN VencChn)
{
	...
	s32Ret = API_COST_TIME_LOG(CVI_VENC_GetRcParam(VencChn, pstRcParam), "CVI_VENC_GetRcParam");
	if (s32Ret != CVI_SUCCESS) {
	...
	} else if (!strcmp(pIc->codec, "mjp") && pIc->rcMode == SAMPLE_RC_CBR) {
		pstRcParam->stParamMjpegCbr.u32MaxQfactor = pIc->maxQuality;
		pstRcParam->stParamMjpegCbr.u32MinQfactor = pIc->minQuality;
	} else if (!strcmp(pIc->codec, "mjp") && pIc->rcMode == SAMPLE_RC_VBR) {
		pstRcParam->stParamMjpegVbr.u32MaxQfactor = pIc->maxQuality;
		pstRcParam->stParamMjpegVbr.u32MinQfactor = pIc->minQuality;
	}

	s32Ret = API_COST_TIME_LOG(CVI_VENC_SetRcParam(VencChn, pstRcParam), "CVI_VENC_SetRcParam");
	if (s32Ret != CVI_SUCCESS) {
	...
	VENC_CHN VencChn)
{
	...
	s32Ret = API_COST_TIME_LOG(CVI_VENC_GetFrameLostStrategy(VencChn, pstFL), "CVI_VENC_GetFrameLostStrategy");
	if (s32Ret != CVI_SUCCESS) {
	...
	s32Ret = API_COST_TIME_LOG(CVI_VENC_SetFrameLostStrategy(VencChn, pstFL), "CVI_VENC_SetFrameLostStrategy");
	if (s32Ret != CVI_SUCCESS) {
	...
	VENC_CHN VencChn)
{
	...
	s32Ret = API_COST_TIME_LOG(CVI_VENC_GetSuperFrameStrategy(VencChn, pstsf), "CVI_VENC_GetSuperFrameStrategy");
	if (s32Ret != CVI_SUCCESS) {
...
CVI_S32 SAMPLE_COMM_VENC_SetModParam(const commonInputCfg *pCic)
{
	...
	for (VENC_MODTYPE_E modtype = MODTYPE_H264E; modtype <= MODTYPE_JPEGE; modtype++) {
		...
		s32Ret = API_COST_TIME_LOG(CVI_VENC_SetModParam(&stModParam), "CVI_VENC_SetModParam");
		if (s32Ret != CVI_SUCCESS) {
...
CVI_S32 SAMPLE_COMM_VENC_SetJpegParam(chnInputCfg *pIc, VENC_CHN VencChn)
{
	...
	s32Ret = API_COST_TIME_LOG(CVI_VENC_GetJpegParam(VencChn, pstJpegParam), "CVI_VENC_GetJpegParam");
	if (s32Ret != CVI_SUCCESS) {
	...
	s32Ret = API_COST_TIME_LOG(CVI_VENC_SetJpegParam(VencChn, pstJpegParam), "CVI_VENC_SetJpegParam");
	if (s32Ret != CVI_SUCCESS) {
...
CVI_S32 SAMPLE_COMM_VENC_SetH264Trans(chnInputCfg *pIc, VENC_CHN VencChn)
{
	...
	s32Ret = API_COST_TIME_LOG(CVI_VENC_GetH264Trans(VencChn, &h264Trans), "CVI_VENC_GetH264Trans");
	if (s32Ret != CVI_SUCCESS) {
	...
	s32Ret = API_COST_TIME_LOG(CVI_VENC_SetH264Trans(VencChn, &h264Trans), "CVI_VENC_SetH264Trans");
	if (s32Ret != CVI_SUCCESS) {
...
CVI_S32 SAMPLE_COMM_VENC_SetH265Trans(chnInputCfg *pIc, VENC_CHN VencChn)
{
	...
	s32Ret = API_COST_TIME_LOG(CVI_VENC_GetH265Trans(VencChn, &h265Trans), "CVI_VENC_GetH265Trans");
	if (s32Ret != CVI_SUCCESS) {
	...
	s32Ret = API_COST_TIME_LOG(CVI_VENC_SetH265Trans(VencChn, &h265Trans), "CVI_VENC_SetH265Trans");
	if (s32Ret != CVI_SUCCESS) {
...
CVI_S32 SAMPLE_COMM_VENC_SetH264Vui(chnInputCfg *pIc, VENC_CHN VencChn)
{
	...
	s32Ret = API_COST_TIME_LOG(CVI_VENC_GetH264Vui(VencChn, &h264Vui), "CVI_VENC_GetH264Vui");
	if (s32Ret != CVI_SUCCESS) {
	...
	s32Ret = API_COST_TIME_LOG(CVI_VENC_SetH264Vui(VencChn, &h264Vui), "CVI_VENC_SetH264Vui");
	if (s32Ret != CVI_SUCCESS) {
...
CVI_S32 SAMPLE_COMM_VENC_SetH265Vui(chnInputCfg *pIc, VENC_CHN VencChn)
{
	...
	s32Ret = API_COST_TIME_LOG(CVI_VENC_GetH265Vui(VencChn, &h265Vui), "CVI_VENC_GetH265Vui");
	if (s32Ret != CVI_SUCCESS) {
	...
	s32Ret = API_COST_TIME_LOG(CVI_VENC_SetH265Vui(VencChn, &h265Vui), "CVI_VENC_SetH265Vui");
	if (s32Ret != CVI_SUCCESS) {
...
CVI_S32 SAMPLE_COMM_VENC_SetChnParam(chnInputCfg *pIc, VENC_CHN VencChn)
{
	...
	s32Ret = API_COST_TIME_LOG(CVI_VENC_GetChnParam(VencChn, pstChnParam), "CVI_VENC_GetChnParam");
	if (s32Ret != CVI_SUCCESS) {
		CVI_VENC_ERR("CVI_VENC_GetJpegParam\n");
		return CVI_FAILURE;
	}
	...
	s32Ret = API_COST_TIME_LOG(CVI_VENC_SetChnParam(VencChn, pstChnParam), "CVI_VENC_SetChnParam");
	if (s32Ret != CVI_SUCCESS) {
	...
	VENC_CHN VencChn)
{
	...
	s32Ret = API_COST_TIME_LOG(CVI_VENC_GetH264SliceSplit(VencChn, pstH264Split), "CVI_VENC_GetH264SliceSplit");
	if (s32Ret != CVI_SUCCESS) {
	...
	s32Ret = API_COST_TIME_LOG(CVI_VENC_SetH264SliceSplit(VencChn, pstH264Split), "CVI_VENC_SetH264SliceSplit");
	if (s32Ret != CVI_SUCCESS) {
	...
	VENC_CHN VencChn)
{
	...
	s32Ret = API_COST_TIME_LOG(CVI_VENC_GetH265SliceSplit(VencChn, pstH265Split), "CVI_VENC_GetH265SliceSplit");
	if (s32Ret != CVI_SUCCESS) {
	...
	s32Ret = API_COST_TIME_LOG(CVI_VENC_SetH265SliceSplit(VencChn, pstH265Split), "CVI_VENC_SetH265SliceSplit");
	if (s32Ret != CVI_SUCCESS) {
...
CVI_S32 SAMPLE_COMM_VENC_SetH264Dblk(chnInputCfg *pIc, VENC_CHN VencChn)
{
	...
	s32Ret = API_COST_TIME_LOG(CVI_VENC_GetH264Dblk(VencChn, &h264Dblk), "CVI_VENC_GetH264Dblk");
	if (s32Ret != CVI_SUCCESS) {
	...
	s32Ret = API_COST_TIME_LOG(CVI_VENC_SetH264Dblk(VencChn, &h264Dblk), "CVI_VENC_SetH264Dblk");
	if (s32Ret != CVI_SUCCESS) {
...
CVI_S32 SAMPLE_COMM_VENC_SetH265Dblk(chnInputCfg *pIc, VENC_CHN VencChn)
{
	...
	s32Ret = API_COST_TIME_LOG(CVI_VENC_GetH265Dblk(VencChn, &h265Dblk), "CVI_VENC_GetH265Dblk");
	if (s32Ret != CVI_SUCCESS) {
	...
	s32Ret = API_COST_TIME_LOG(CVI_VENC_SetH265Dblk(VencChn, &h265Dblk), "CVI_VENC_SetH265Dblk");
	if (s32Ret != CVI_SUCCESS) {
	...
	VENC_CHN VencChn)
{
	...
	s32Ret = API_COST_TIME_LOG(CVI_VENC_GetH264IntraPred(VencChn, pstH264IntraPred), "CVI_VENC_GetH264IntraPred");
	if (s32Ret != CVI_SUCCESS) {
	...
	s32Ret = API_COST_TIME_LOG(CVI_VENC_SetH264IntraPred(VencChn, pstH264IntraPred), "CVI_VENC_SetH264IntraPred");
	if (s32Ret != CVI_SUCCESS) {
		...
		VENC_GOP_ATTR_S *pstGopAttr)
{
	...
	s32Ret = API_COST_TIME_LOG(CVI_VENC_StartRecvFrame(VencChn, &stRecvParam), "CVI_VENC_StartRecvFrame");
	if (s32Ret != CVI_SUCCESS) {

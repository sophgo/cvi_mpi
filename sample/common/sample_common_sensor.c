...
CVI_S32 SAMPLE_COMM_SNS_GetSize(SAMPLE_SNS_TYPE_E enMode, PIC_SIZE_E *penSize)
{
	...
	case GCORE_GC05A2_MIPI_1M_60FPS_10BIT:
	...
	case CVSENS_CV2003_1L_MIPI_1M_720P_30FPS_10BIT:
#ifdef FPGA_PORTING
	...
	case SONY_IMX327_MIPI_1M_30FPS_10BIT_WDR2TO1:
		...
		*penSize = PIC_720P;
		break;
	case GCORE_GC05A2_MIPI_960P_30FPS_10BIT:
	...
	case GCORE_GC20C3_MIPI_2M_30FPS_10BIT:
	...
	case IMGDS_MIS4001_MIPI_4M_1440P_30FPS_10BIT:
	...
	case SMS_SC533HAI1_2L_MIPI_5M_30FPS_10BIT:
	...
	case SMS_SC035HGS_2L_MIPI_480P_180FPS_10BIT:
...
CVI_VOID *SAMPLE_COMM_SNS_GetSnsObj(SAMPLE_SNS_TYPE_E enSnsType)
{
...
#endif
#if defined(SENSOR_GCORE_GC20C3)
	case GCORE_GC20C3_MIPI_2M_30FPS_10BIT:
		return &stSnsGc20c3_Obj;
#endif
...
#endif
#if defined(SENSOR_GCORE_GC4683)
	case GCORE_GC4683_MIPI_4M_60FPS_10BIT:
	case GCORE_GC4683_MIPI_1M_120FPS_10BIT:
	...
	case IMGDS_MIS2008_MIPI_2M_1080P_30FPS_12BIT:
		...
		break;
#endif
#if defined(SENSOR_ID_MIS2008_1L)
	case IMGDS_MIS2008_1L_MIPI_2M_1080P_30FPS_12BIT:
		pSnsObj = &stSnsMIS2008_1L_Obj;
		break;
#endif
#if defined(SENSOR_ID_MIS4001)
	case IMGDS_MIS4001_MIPI_4M_1440P_30FPS_10BIT:
		pSnsObj = &stSnsMIS4001_Obj;
		break;
#endif
	...
	case OV_OS08A20_SLAVE_MIPI_8M_30FPS_10BIT_WDR2TO1:
		...
		break;
#endif
#if defined(SENSOR_OV_OS08C10)
	case OV_OS08C10_MIPI_2M_60FPS_10BIT_WDR2TO1:
	case OV_OS08C10_MIPI_1M_120FPS_10BIT_WDR2TO1:
		pSnsObj = &stSnsOs08c10_Obj;
		break;
#endif
	...
	case SMS_SC531AI_2L_MIPI_5M_30FPS_10BIT:
		...
		break;
#endif
#if defined(SENSOR_SMS_SC533HAI)
	case SMS_SC533HAI_MIPI_5M_30FPS_10BIT:
	case SMS_SC533HAI_MIPI_5M_30FPS_10BIT_WDR2TO1:
		pSnsObj = &stSnsSC533HAI_Obj;
		break;
#endif
#if defined(SENSOR_SMS_SC533HAI_2L)
	case SMS_SC533HAI_2L_MIPI_5M_30FPS_10BIT:
		pSnsObj = &stSnsSC533HAI_2L_Obj;
		break;
#endif
#if defined(SENSOR_SMS_SC533HAI1_2L)
	case SMS_SC533HAI1_2L_MIPI_5M_30FPS_10BIT:
		pSnsObj = &stSnsSC533HAI1_2L_Obj;
		break;
#endif

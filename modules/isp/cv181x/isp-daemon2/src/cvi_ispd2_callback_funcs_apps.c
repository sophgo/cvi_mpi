	...
	TJSONRpcContentOut *ptContentOut, JSONObject *pJsonResponse)
{
	...
	if ((stVIVPSSMode.aenMode[pstFrameInfo->ViPipe] == VI_OFFLINE_VPSS_ONLINE)
		...
		CVI_VPSS_GetGrpProcAmp(pstFrameInfo->VpssGrp, PROC_AMP_BRIGHTNESS, &(astVPSSAdjGrp_System.s32Brightness));
		CVI_VPSS_GetGrpProcAmp(pstFrameInfo->VpssGrp, PROC_AMP_CONTRAST, &(astVPSSAdjGrp_System.s32Contrast));
		CVI_VPSS_GetGrpProcAmp(pstFrameInfo->VpssGrp, PROC_AMP_SATURATION, &(astVPSSAdjGrp_System.s32Saturation));
	...
	if (bSetVPSSDefault) {
		CVI_VPSS_SetGrpProcAmp(pstFrameInfo->VpssGrp, PROC_AMP_BRIGHTNESS, astVPSSAdjGrp_System.s32Brightness);
		CVI_VPSS_SetGrpProcAmp(pstFrameInfo->VpssGrp, PROC_AMP_CONTRAST, astVPSSAdjGrp_System.s32Contrast);
		CVI_VPSS_SetGrpProcAmp(pstFrameInfo->VpssGrp, PROC_AMP_SATURATION, astVPSSAdjGrp_System.s32Saturation);
	...
	TJSONRpcContentOut *ptContentOut, JSONObject *pJsonResponse)
{
	...
	if (eImageSrc == IMAGE_FROM_VI) {
		...
		if ((stVIVPSSMode.aenMode[ViPipe] == VI_OFFLINE_VPSS_ONLINE)
			...
			// backup and apply default VPSS Adjustment
			CVI_VPSS_GetGrpProcAmp(VpssGrp, PROC_AMP_BRIGHTNESS, &(astVPSSAdjGrp_System.s32Brightness));
			CVI_VPSS_GetGrpProcAmp(VpssGrp, PROC_AMP_CONTRAST, &(astVPSSAdjGrp_System.s32Contrast));
			CVI_VPSS_GetGrpProcAmp(VpssGrp, PROC_AMP_SATURATION, &(astVPSSAdjGrp_System.s32Saturation));

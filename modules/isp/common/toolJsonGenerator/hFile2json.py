...
typedef struct _VPSS_ATTR_S {
	CVI_S32 brightness[16]; /*RW; Range:[0x0, 0x64]*/
	CVI_S32 contrast[16]; /*RW; Range:[0x0, 0x64]*/
	CVI_S32 saturation[16]; /*RW; Range:[0x0, 0x64]*/
	CVI_S32 hue[16]; /*RW; Range:[0x0, 0x64]*/
...
class MarcoDict():
    def __init__(self, strlist):
        ...
        if is_number(self.marcoDict["AWB_SENSOR_NUM"]) == False:
            num = self.marcoDict["VI_MAX_PIPE_NUM"]

...
function run_all_sample_audio() {
    cmds_list="'sample_audio 0 --list -r 8000 -R 8000 -c 0 -p 480 -C 0 -V 0 -F Cvi_8_8k_2chn.g726 -T 10'
        'sample_audio 0 --list -r 16000 -R 8000 -c 2 -p 320 -C 1 -V 0 -F Cvi_16_8k_2chn.g711a -T 10'
        'sample_audio 0 --list -r 32000 -R 8000 -c 2 -p 320 -C 2 -V 0 -F Cvi_32_8k_2chn.g711mu -T 10'
        'sample_audio 1 --list -r 16000 -R 8000 -c 2 -p 320 -C 0 -V 0 -F Cvi_16_8k_2chn.g726 -T 10'
        'sample_audio 1 --list -r 32000 -R 8000 -c 2 -p 320 -C 1 -V 0 -F Cvi_32_8k_2chn.g711a -T 10'
        'sample_audio 1 --list -r 16000 -R 8000 -c 2 -p 320 -C 2 -V 0 -F Cvi_16_18k_2chn.g711mu -T 10'
        'sample_audio 2 --list -r 8000 -R 8000 -c 2 -p 480 -C 0 -V 0 -F Cvi_8_8k_2chn.g726 -T 10'
        'sample_audio 2 --list -r 8000 -R 16000 -c 2 -p 320 -C 1 -V 0 -F Cvi_16_8k_2chn.g711a -T 10'
        'sample_audio 2 --list -r 8000 -R 32000 -c 2 -p 320 -C 2 -V 0 -F Cvi_32_8k_2chn.g711mu -T 10'
        'sample_audio 3 --list -r 8000 -R 16000 -c 2 -p 320 -C 0 -V 0 -F Cvi_16_8k_2chn.g726 -T 10'
        'sample_audio 3 --list -r 8000 -R 32000 -c 2 -p 320 -C 1 -V 0 -F Cvi_32_8k_2chn.g711a -T 10'
        'sample_audio 3 --list -r 8000 -R 8000 -c 2 -p 320 -C 1 -V 0 -F Cvi_32_8k_2chn.g711a -T 10'

...
struct Lontium_IC_Mode lt9611 = {
	single_port_mipi_A,
	// mipi_port_cnt; //single_port_mipi_A(Pin38~46) or single_port_mipi_B(Pin49~58) or dual_port_mipi
...
static const char * const s_hdmi_resolution_arr[] = {
	"1024x768_60HZ",
	"1280x720_60HZ",
	"1280x1024_60HZ",
	"1600x1200_60HZ",
...
// DTV
// hfp, hs, hbp,hact,htotal,vfp, vs, vbp,vact,vtotal, hfp, hs,
// hbp,hact,htotal,vfp, vs, vbp,vact,vtotal, h_polary, v_polary, vic, pclk_khz
static struct video_timing video_640x480_60Hz = {
	16, 96, 48, 640, 800, 10, 2, 33, 480, 525, 0, 0, 1, AR_4_3, 25000};
static struct video_timing video_720x480_60Hz = {
	16, 62, 60, 720, 858, 9, 6, 30, 480, 525, 0, 0, 2, AR_4_3, 27000};
static struct video_timing video_720x576_50Hz = {
...
static struct video_timing video_1280x720_50Hz = {
	440, 40, 220, 1280, 1980, 5, 5, 20, 720, 750, 1, 1, 19, AR_16_9, 74250};
static struct video_timing video_1280x720_30Hz = {
...
static struct video_timing video_1920x1080_50Hz = {
	528, 44, 148, 1920, 2640, 4, 5, 36, 1080, 1125, 1, 1, 31, AR_16_9, 148500};
static struct video_timing video_1920x1080_30Hz = {
	88, 44, 148, 1920, 2200, 4, 5, 36, 1080, 1125, 1, 1, 34, AR_16_9, 74250};
static struct video_timing video_1920x1080_25Hz = {
	528, 44, 148, 1920, 2640, 4, 5, 36, 1080, 1125, 1, 1, 33, AR_16_9, 74250};
static struct video_timing video_1920x1080_24Hz = {
	638, 44, 148, 1920, 2750, 4, 5, 36, 1080, 1125, 1, 1, 32, AR_16_9, 74250};

static struct video_timing video_3840x2160_30Hz = {
	176, 88, 296, 3840, 4400, 8, 10, 72, 2160, 2250, 1, 1, 95, AR_16_9, 297000};
static struct video_timing video_3840x2160_25Hz = {
	1056, 88, 296, 3840, 5280, 8, 10, 72, 2160, 2250, 1, 1, 94, AR_16_9, 297000};
static struct video_timing video_3840x2160_24Hz = {
	1276, 88, 296, 3840, 5500, 8, 10, 72, 2160, 2250, 1, 1, 93, AR_16_9, 297000};

static struct video_timing video_1024x768_60Hz = {
	24, 136, 160, 1024, 1344, 3, 6, 29, 768, 806, 0, 0, 0, AR_16_9, 65000};
static struct video_timing video_1280x1024_60Hz = {
	48, 112, 248, 1280, 1688, 1, 3, 38, 1024, 1066, 1, 1, 0, AR_16_9, 108000};
static struct video_timing video_1600x1200_60Hz = {
	64, 192, 304, 1600, 2160, 1, 3, 46, 1200, 1250, 1, 1, 0, AR_16_9, 162000};

static struct video_timing video_1280x800_60Hz = {
	28, 32, 100, 1280, 1440, 2, 6, 15, 800, 823, 0, 0, 0, AR_16_9, 71000};

static struct video_timing video_2560x1440_60Hz = {
	248, 44, 148, 2560, 3000, 3, 5, 33, 1440, 1481, 1, 1, 0, AR_16_9, 266580};

// code struct video_timing video_2560x1080_60Hz =
//	{248,44, 148,2560,2720,  4,  5, 11, 1080,1100, 1,1,0,AR_16_9,198000};

// //VESA-DMT
// code struct video_timing video_800x600_60Hz =
//	{48, 128, 88, 800, 1056,  1,  4,  23, 600, 628,     1,1,0,AR_16_9,40000};
// code struct video_timing video_1024x768_60Hz =
//	{24, 136, 160, 1024, 1344,  3,  6,  29, 768, 806,   0,0,0,AR_16_9,65000};
// code struct video_timing video_1280x768_60Hz =
//	{48, 32,   80, 1280, 1440,  3,  7,  12, 768, 790,   1,0,0,AR_16_9,68250}; //reduced blank
// code struct video_timing video_1280x768_60Hz =
//	{64, 128,   192, 1280, 1664,  3,  7,  20, 768, 798,   0,1,0,AR_16_9,79500}; //Normal

// //20190328
// code struct video_timing video_1280x800_60Hz =
//	{72, 128, 200, 1280, 1680,  3,  6,  22, 800, 831, 0,1,0,AR_16_9,83500};
// code struct video_timing video_1280x800_60Hz =
//	{28, 32, 100, 1280, 1440,  2,  6,  15, 800, 823, 0,0,0,AR_16_9,71000};
// code struct video_timing video_1280x960_60Hz =
//	{96, 112, 312, 1280, 1800,  1,  3,  36, 960, 1000, 1,1,0,AR_16_9,108000};

// code struct video_timing video_1280x800_30Hz =
//	{72, 128, 200, 1280, 1680,  3,  6,  22, 800, 831, 0,1,0,AR_16_9,41750};
// code struct video_timing video_1280x960_30Hz =
//	{96, 112, 312, 1280, 1800,  1,  3,  36, 960, 1000, 1,1,0,AR_16_9,54000};

// code struct video_timing video_1280x1024_60Hz =
//	{48, 112, 248, 1280, 1688,  1,  3,  38, 1024, 1066, 1,1,0,AR_16_9,108000};
// code struct video_timing video_1600x1200_60Hz =
//	{64, 192, 304, 1600, 2160,  1,  3,  46, 1200, 1250, 1,1,0,AR_16_9,162000};
// code struct video_timing video_1680x1050_60Hz =
//	{48, 32,   80, 1680, 1840,  3,  6,  21, 1050, 1080, 1,0,0,AR_16_9,119000}; //reduced blank
// code struct video_timing video_1680x1050_60Hz =
//	{104, 176,   280, 1680, 2240,  3,  6,  30, 1050, 1089, 0,1,0,AR_16_9,146250};//Normal

// code struct video_timing video_1280x720_30Hz =
//	{1760, 40, 220,1280,  3300,  5,  5,  20, 720, 750,   1,1,0, AR_16_9,74250};
// code struct video_timing video_1024x600_60Hz =
//	{60,60, 100,1024,  1154,  2,  5, 10, 600, 617,      1,1,0,AR_16_9,34000};

// code struct video_timing video_1366x768_60Hz =
//	{14, 56,  64,1366,  1500,  1,  3,  28, 768,  800,   1,1,0, AR_16_9,74000};

// code struct video_timing video_2560x1440_50Hz =
//	{176,272, 448,2560,  3456,  3,  5, 36, 1440, 1484, 1,1,0, AR_16_9,256250};
// code struct video_timing video_2560x1440_60Hz =
//	{48,32, 80,2560,  2720,  3,  5, 33, 1440, 1481, 1,1,0, AR_16_9,241500};

// //20180731 //hfp, hs, hbp,hact,htotal,vfp, vs, vbp,vact,vtotal, pclk_khz
// code struct video_timing video_2560x1600_60Hz =
//	{48,32, 80,2560,  2720,  3,  6, 37, 1600, 1646, 1,1,0,AR_16_9,268500};

// //VR timing
// code struct video_timing video_3840x1080_60Hz =
//	{176,88, 296,3840,  4400,  4,  5,  36, 1080, 1125, 1,1,0, AR_16_9,297000};
// code struct video_timing video_2560x720_60Hz =
//	{220,80, 440,2560,  3300,  5,  5,  20, 720, 750, 1, 1, 0, AR_16_9,148500};

// //mipi panel resolution
// code struct video_timing video_1080x1920_60Hz =
//	{  4,  5,  36, 1080, 1125, 88, 44, 148,1920,2200, 1,1,0,AR_16_9,148500};
// code struct video_timing video_720x1280_60Hz =
//	{  5,  5, 20, 720, 750, 110,40, 220,1280, 1650, 1,1,0,AR_16_9,74250};
// code struct video_timing video_540x960_60Hz =
//	{30, 10, 30, 540, 610, 10, 10, 10, 960, 990, 1,1,0,AR_16_9,33500};

// others
static struct video_timing video_1200x1920_60Hz = {
	180, 60, 160, 1200, 1600, 35, 10, 25, 1920, 1990, 1, 1, 0, AR_16_9, 191040};
static struct video_timing video_1920x720_60Hz = {
...
void LT9611_MIPI_Video_Timing(struct video_timing *video_format) // weiguo
{
	...
	lt9611_i2c_write_byte(0x1a, (CVI_U8)(((video_format->hfp / 256) << 4) +
			(video_format->hs + video_format->hbp) / 256)); // 20180901
